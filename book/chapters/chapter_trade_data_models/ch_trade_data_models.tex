...
First important item is the fitting universe. The common practice is to limit the usniverse to stocks that would have at least 100 trades per bin in every bin. This avoids averaging issues with empty bins.
