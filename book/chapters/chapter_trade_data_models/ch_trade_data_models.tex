...
\section{Normalizing Analytics}\label{in:normalization1}\label{in:tda1}\label{in:norm1}
...
\subsection{Remainder (of the Day) Volume}\label{in:vol_prof1}
...
% Auctions Volume
\subsection{Auctions Volume} \label{in:close4}
...
\section{Limit Order Book (LOB): Studying Its Dynamics}\label{in:labmod1}
...
\subsection{Models Based on Hawkes Process}\label{in:hawk1}
...
\section{Models for Hidden Liquidity} \label{in:hidden2}
