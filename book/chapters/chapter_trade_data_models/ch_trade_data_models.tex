...
Note that since you guys are using a lot of notes to each other here. You can make them easy to find like this: \textnote{[TODO: Maybe make notes easier to find?]} 
\btodo{You can to these on the side.} All these special side-notes now appear in a list after the Table of Contents. You can hyperlink right to the location of the note. These can even point from the side to the note. \fancytodo{See! Like this.} \\
\missingfigure{You can even make a reference to a soon to be inserted figure!}
