...
To illustrate the presence of hidden orders, we consider the Level~III data whose description is given in Section\todo{Missing Section Reference} (Table~\ref{tab:level3data}). With this, we can construct the order book in real time (Figure~\ref{fig:limbk1}). For modeling some key elements considered are:
        \begin{enumerate}[--]
