...
\begin{equation}
	IS = side\frac{p_{\text{exec}} - p_{\text{arrival}}}{p_{\text{arrival}}}
\end{equation}
...
\item This benchmarks tells us nothing on how close the trade was to the ``best price'' and thus, on it's own does not provide any additional support on how to improve the particular trading approach
\end{itemize}
