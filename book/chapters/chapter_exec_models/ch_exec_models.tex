...
\begin{itemize}
\item At constant cost: reduce the risk by neutralizing market or factor exposures. 
\item At constant risk: reduce the cost by allowing slower trading than a list of individual IS strategies.
\end{itemize}
