...
\todo{Chapter 3/4: - shrink the ``depth'' of the time series chapter (e.g mathematical derivations, etc) to make it easier to read.  - instead of derivations, focus more on hands on examples that readers can play with in python. Chapter 3 and 4 are done; Daniel will focus on examples.}
