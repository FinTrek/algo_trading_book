...
\begin{center} \textbf{Relation to Other Dimension-Reduction Methods} \end{center} \twomedskip
...
% Problem
\prob Consider the weekly exchange rate data used in Hu and Tsay (2014)~\cite{hutsay14}: British Bound ($y_{1t}$), Norwegian Kroner ($y_{2t}$), Swedish Kroner ($y_{3t}$), Swiss Franc ($y_{4t}$), Canadian Dollar ($y_{5t}$), Singapore Dollar ($y_{6t}$) and Australian Dollar ($y_{7t}$) against US Dollar from March 22, 2000 to October 26, 2011.
