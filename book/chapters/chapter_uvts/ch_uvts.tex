...
{\noindent\bfseries\large Model Diagnostics} \twomedskip
...
\noindent\textbf{Stylized fact 5:} Volatility clustering: High volatility events tend to cluster in time and this can be measured through positive correlations that exist over several lags.
