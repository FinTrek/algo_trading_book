% !TEX root = ../../book.tex
\chapter{The Technology Stack\label{chap:ch_tech}} \label{in:exec_tech1}
...
\section{From Client Instruction to Trade Reconciliation}\label{in:trad_infr1}
...
\section{Algorithmic Trading Infrastructure}\label{in:trad_infr3}
