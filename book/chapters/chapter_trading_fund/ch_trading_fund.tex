...
\fancytodo{We used to have some graphics on the orderbook. Can we move these here?}

This process happen in a continuous fashion between the opening of the market and the closing. This continuous phase is preceded and followed by two discontinuos phases called the Open and Close auctions which we'll discuss shortly.
